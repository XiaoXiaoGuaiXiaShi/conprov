...
6. Accessing the container's web service or interacting with the container through its bash shell will trigger the recording of the corresponding activities. 
6. cd ../provData
