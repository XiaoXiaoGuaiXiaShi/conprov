...
static const char RL_STR_SETPGID[] = "setpgid";                            // setpgid
...
static const char RL_STR_EPOLL[] = "epoll";                               // epoll operation
...
uint64_t relation_id(const char *str)
{
    ...
    MATCH_AND_RETURN(str, RL_STR_SETPGID, RL_SETPGID);
